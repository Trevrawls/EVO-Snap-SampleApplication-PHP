...
switch ($_msgFormat)
{
	...
	case 'HTTP':
		...
		$client = new HTTPClient($_identityToken, $_baseURL, $_merchantProfileId[0]['ProfileId'], $_merchantProfileId[0]['ServiceId'] , $_applicationProfileId);
		break;
	case 'JSON': 
	...
	case 'XML': // TODO IMPLEMENT THE XML CLIENT
		...
		$client = new XMLClient($_identityToken, $_baseURL, $_merchantProfileId[0]['ProfileId'], $_merchantProfileId[0]['ServiceId'] , $_applicationProfileId);
		break; 
}
